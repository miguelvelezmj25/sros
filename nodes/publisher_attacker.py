...
import examples_rclpy_minimal_publisher.probe_attacker as probe
...
def main(args=None):
    ...
    #node = rclpy.create_node('attacker_publisher')
    # WILL INSTRUMENT AUTOMATICALLY
    node = probe.Probe.create_node(rclpy, 'attacker_publisher')
